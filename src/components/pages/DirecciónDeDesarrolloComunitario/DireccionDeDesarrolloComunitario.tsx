    ...
    <div className="direccion-desarrollo-comunitario-container">
      <div className="ddc-header">
        ...
        <div className="hero">
          <img
            src={imagen}
            alt="Edificio Dirección de Desarrollo Comunitario"
      ...
      <div className="ddc-content">
        ...
        <div className="Cuadro2">
          ...
          <div className="intro">
            ...
            <p>
              ...
              además, el desarrollo de acciones sociales con otros servicios
              municipales, instituciones públicas o privadas en beneficio de la
              comunidad.
            </p>
          </div>
          ...
          <ul>
            <li>
              <strong>Bernardita Bakovic Iturriaga</strong>
            </li>
            <li>
              <a href="mailto:bbakovic@munistgo.cl">bbakovic@munistgo.cl</a>
            </li>
        ...
        <div className="Cuadro1">
          ...
          <ul>
            <li>
              <strong>Eleonora Espinoza Hernández</strong>
            </li>
            <li>Directora</li>
            <li>
              <a href="mailto:eespinoza@munistgo.cl">eespinoza@munistgo.cl</a>
            </li>
        ...
        <div className="Cuadro3">
          ...
          <ul>
            <li>
              <strong>Angie Farías Videla</strong>
            </li>
            <li>
              <a href="mailto:afarias@munistgo.cl">afarias@munistgo.cl</a>
            </li>
            <li>
              22 386 7394 – 22 386 7395 – 22 386 7396 – 22 386 7397 / Rondizzoni
              1859, Interior Parque O’Higgins.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <a href="mailto:wperez@munistgo.cl">wperez@munistgo.cl</a>
            </li>
            <li>
              22 386 7394 – 22 386 7395 – 22 386 7396 – 22 386 7397 / Rondizzoni
              1859, Interior Parque O’Higgins.
        ...
        <div className="Cuadro4">
          ...
          <ul>
            <li>
              <strong>Leslie Briones Rojo</strong>
            </li>
            <li>
              <a href="mailto:lbriones@munistgo.cl">lbriones@munistgo.cl</a>
            </li>
        ...
        <div className="Cuadro5">
          ...
          <ul>
            <li>
              <strong>Eduardo Marante Díaz</strong>
            </li>
            <li>
              <a href="mailto:emarante@munistgo.cl">emarante@munistgo.cl</a>
            </li>
        ...
        <div className="Cuadro6">
          ...
          <ul>
            <li>
              <strong>Marjorie Vásquez Acuña</strong>
            </li>
            <li>
              <a href="mailto:mvasquez@munistgo.cl">mvasquez@munistgo.cl</a>
            </li>
        ...
        <div className="Cuadro7">
          ...
          <ul>
            <li>
              <strong>Nora Muñoz Alfaro</strong>
            </li>
            <li>
              <a href="mailto:nmunoza@munistgo.cl">nmunoza@munistgo.cl</a>
            </li>
        ...
        <div className="Cuadro8">
          <h2>
            Subdirección de Igualdad de Género, Diversidad Sexual e Inclusión
          </h2>
          <ul>
            <li>
              <strong>María Jesús Garrido San Martin</strong>
            </li>
            <li>
              <a href="mailto:mgarrido@munistgo.cl">mgarrido@munistgo.cl</a>
            </li>
