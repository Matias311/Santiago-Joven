...
import imagenPrincipal from "../../../assets/desarrollo-social/hero_desarrollo_social.png";
    ...
    <div className="contenedor-desarrollo">
      <div className="caja-flexible">
        ...
        <div className="caja-imagen">
          <div className="imagen-wrapper">
            <img src={imagenPrincipal} alt="Desarrollo Social" className="imagen-principal" />
          </div>
        </div>
      </div>
      ...
      <div className="seccion-texto">
        ...
        <p className="parrafo">
            ...
            fomentar y potenciar el desarrollo de acciones que mejoren la calidad de vida de los vecinos de la comuna de Santiago. 
            Para eso, pone a disposición oficinas y programas como:
        </p>
        ...
        <p className="departamento">Departamento de Infancia, Adolescencia y Familia</p>

        <ul className="lista">
            <li>Oficina de la Infancia: Polos de Cuidados, Chile Crece Contigo y Línea de Promoción de Derechos.</li>
