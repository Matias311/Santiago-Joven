...
// No existe un endpoint que entregue estas cartas (ver discusión del PR),
// así que se mantienen hardcodeadas igual que en la versión anterior del
// componente, hasta que se defina cómo manejar estos datos en la API.
const ENCABEZADO_FIJO: CartaItem[] = [
  {
    icono: "handshake",
    iconoColor: "#E3E3E3",
    iconoTamaño: "2.5rem",
...
export default function Inicio() {
  ...
  useEffect(() => {
    const cargarDatos = async () => {
      ...
      try {
        ...
        setCategorias(
          (categoriasData || []).map((item: Record<string, unknown>) => ({
            id: String(item.id ?? ""),
            nombre: String(item.nombre ?? ""),
          })),
        );
        setActividadesCalendario(
          (actividadesData || []).map((item: Record<string, unknown>) => ({
            id: String(item.id ?? ""),
            ...
            descripcion: item.descripcion
              ...
              : undefined,
            categoriaId:
              item.categoriaId != null ? String(item.categoriaId) : "",
          })),
        );

        // Una sola pasada sobre actividadesData: separa actividades y
        // talleres en el mismo recorrido (antes eran 2 recorridos
        // independientes del mismo array).
        const { actividades, talleres } = (actividadesData || []).reduce<{
          actividades: ConexionItem[];
          talleres: ConexionItem[];
        }>(
          (acc, item: Record<string, unknown>) => {
            const titulo = String(item.titulo || "");
            if (/taller/i.test(titulo)) {
  ...
  return (
    <>
      {/* encabezado de la pagina principal: no depende de la API, se
          renderiza de inmediato sin esperar los fetches de las demás
          secciones. */}
      <header id="inicio" className="inicio-section">
        ...
        <div className="carta-seccion">
          {ENCABEZADO_FIJO.map((carta: CartaItem) => (
            <Card
              key={carta.titulo}
              icono={carta.icono}
      ...
      {/* El resto del contenido sí depende de la API: mientras carga o si
          hay error, se muestra el estado correspondiente sin bloquear el
          header de arriba. */}
      {loading ? (
        <div className="cargando">Cargando Santiago Joven...</div>
      ) : error ? (
        <div className="error">{error}</div>
      ) : !datosInicio ? (
        <div className="error">No se pudo cargar la información.</div>
      ) : (
        (() => {
          const {
            asesorias,
              ...
              <main className="contenido-principal">
                ...
                <section id="apoyo" className="seccion-informativa">
                  <div className="seccion-encabezado">
                    ...
                    <h2>Apoyo Joven</h2>
                    <p>
                      Te acompañamos en tus trámites, estudios y beneficios.
                      Encuentra aquí toda la asesoría que necesitas.
                    </p>
                  </div>
                  ...
                  <div className="grupo-cartas">
                    ...
                    {preuniversitario.length === 0 ? (
                      <div className="sin-actividades">
                        ...
                        <p>
                          No hay cursos preuniversitarios disponibles por el
                          momento.
                        </p>
                      </div>
                    ) : (
                ...
                <section id="proyeccion" className="seccion-informativa">
                  <div className="seccion-encabezado">
                    ...
                    <p>
                      Impulsa tu futuro. Aquí encontrarás cursos y herramientas
                ...
                <section id="programas" className="seccion-informativa">
                  <div className="seccion-encabezado">
                    ...
                    <p>
                      Conoce los programas insertos en la Oficina de la Juventud
                      para apoyarte.
                    </p>
                  </div>
                  {programas.length === 0 ? (
                ...
                <div className="fondo-gris">
                  ...
                  >
                    <div className="seccion-encabezado">
                      ...
                      <p>
                        Tu bienestar emocional es prioridad. No estás solo/a.
                        Aquí encontrarás canales de ayuda inmediata y
                        profesional.
                      </p>
                    </div>
                    <div className="grupo-cartas">
                      {salud.length === 0 ? (
                        <div className="sin-actividades">
                          ...
                          <p>
                            No hay recursos de salud mental disponibles por el
                            momento.
                          </p>
                        </div>
                      ) : (
                ...
                >
                  <div className="seccion-encabezado">
                    ...
                    <p>
                      Participa en actividades recreativas, culturales y
                      formativas. Conoce gente nueva y desarrolla tus talentos.
                    </p>
                  </div>
                  <div className="contenedor-flex">
                ...
                <div className="fondo-gris">
                  ...
                  >
                    <div className="seccion-encabezado">
                      ...
                      <p>
                        Revisa nuestros próximos eventos. ¡Filtra por categoría
                ...
                >
                  <div className="seccion-encabezado">
                    ...
                    <p>
                      Ayúdanos a mejorar los programas comunales. Estas
                      encuestas son anónimas y nos sirve para generar
                      estadísticas y nuevas soluciones.
                    </p>
                  </div>
                ...
                <div className="fondo-gris">
                  ...
                  >
                    <div className="seccion-encabezado">
                      ...
                      <p>
                        Si tienes opiniones acerca de la pagina, hazlo saber
                        para lograr mejorar la pagina!
                      </p>
                    </div>
                    <div className="formulario-opinion">
                      ...
                      <div className="formulario-footer">
                        <button className="btn-enviar-opinion">
                          Enviar Opinión
                        </button>
                        <span>
                          Para enviar un comentario, debe estar con sesión
                          iniciada
                        </span>
                      </div>
                    </div>
                ...
                >
                  <div className="seccion-encabezado">
                    ...
                    <p>
                      ¿Tienes preguntas? Escríbenos. También puedes visitarnos
                      en nuestra oficina.
                    </p>
                  </div>
                  <div className="contacto-layout">
                    <div className="formulario-contacto">
                      ...
                      <label>Mensaje</label>
                      <textarea></textarea>
                      <button className="btn-enviar-contacto">
                        Enviar Mensaje
                      </button>
                    </div>
